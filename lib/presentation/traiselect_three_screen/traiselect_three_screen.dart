...
class TraiselectThreeScreen extends StatelessWidget {TraiselectThreeScreen({Key? key}) : super(key: key);
...
/// Section Widget
Widget _buildFacil(BuildContext context) { return Expanded(child: Padding(padding: EdgeInsets.only(left: 7.h, top: 6.v, bottom: 6.v), child: CustomRadioButton(width: 211.h, text: "Facil", value: "Facil", groupValue: radioGroup, isRightCheck: true, onChange: (value) {radioGroup = value;}))); } 
/// Section Widget
Widget _buildPrincipiante(BuildContext context) { return Expanded(child: Padding(padding: EdgeInsets.only(left: 8.h, top: 7.v, bottom: 3.v), child: CustomRadioButton(width: 211.h, text: "Principiante", value: "Principiante", groupValue: radioGroup1, isRightCheck: true, onChange: (value) {radioGroup1 = value;}))); } 
/// Section Widget
Widget _buildIntermedio(BuildContext context) { return Expanded(child: Padding(padding: EdgeInsets.only(left: 9.h, top: 5.v, bottom: 5.v), child: CustomRadioButton(width: 207.h, text: "Intermedio", value: "Intermedio", groupValue: radioGroup2, isRightCheck: true, onChange: (value) {radioGroup2 = value;}))); } 
/// Section Widget
Widget _buildAvanzado(BuildContext context) { return Expanded(child: Padding(padding: EdgeInsets.only(left: 8.h, top: 6.v, bottom: 4.v), child: CustomRadioButton(width: 211.h, text: "Avanzado", value: "Avanzado", groupValue: radioGroup3, isRightCheck: true, onChange: (value) {radioGroup3 = value;}))); } 
/// Section Widget
Widget _buildExperto(BuildContext context) { return Expanded(child: Padding(padding: EdgeInsets.only(left: 7.h, top: 7.v, bottom: 3.v), child: CustomRadioButton(width: 211.h, text: "Experto", value: "Experto", groupValue: radioGroup4, isRightCheck: true, onChange: (value) {radioGroup4 = value;}))); } 
/// Section Widget
Widget _buildContinuar(BuildContext context) { return CustomOutlinedButton(text: "Continuar", margin: EdgeInsets.only(left: 50.h, right: 51.h, bottom: 56.v), buttonStyle: CustomButtonStyles.outlineBlackTL22); } 
